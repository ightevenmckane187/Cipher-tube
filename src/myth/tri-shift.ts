...
export const TriShiftInterpretations: Record<string, TriShiftInterpretation> = {
  ...
  coding: {
    ...
    description:
      "legacy variable 'conconcom' passed through a pipeline (abstraction, cleanup, optimization) repeated thrice yields '+++' (clarity, motion).",
    mantra: "Input × Transformation = Improvement.",
  },
  puzzle: {
    name: "The Escalation Sequence",
    description:
      "Repetition (Con-Con-Com) -> Mutation (×××) -> Multiplication -> Growth (+++).",
    mantra: "Repetition, Mutation, Multiplication, Growth.",
  },
};

export const UnifiedMantra =
