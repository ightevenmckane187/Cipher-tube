...
export class PersistenceLayer {
    ...
    save(data: any, key: string): Buffer {
        ...
        // Security Fix: Use Buffer.alloc instead of allocUnsafe to prevent uninitialized memory leak hazards
        ...
        // Compute HMAC signature directly from zero-copy payload subarray
