  ...
  res.send(`
        ...
        <body>
            ...
            <main id="main-content">
                ...
                <section id="mythic-mirror">
                    ...
                    <div id="archetype-info" aria-live="polite">
                        <div class="info-placeholder">Hover or focus on an archetype above to view its mandate.</div>
                    </div>
            ...
            <script nonce="${res.locals.nonce}">
                ...
                const defaultPlaceholder = '<div class="info-placeholder">Hover or focus on an archetype above to view its mandate.</div>';
