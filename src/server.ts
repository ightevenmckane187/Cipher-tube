  ...
  res.send(`
        ...
        <body>
            ...
            <main id="main-content">
                ...
                <section id="mythic-mirror">
                    ...
                    <div id="archetype-info" aria-live="polite">
                        <span class="info-placeholder">Hover or focus an archetype to view its mandate.</span>
                    </div>
            ...
            <script nonce="${res.locals.nonce}">
                ...
                const defaultPlaceholderHTML = '<span class="info-placeholder">Hover or focus an archetype to view its mandate.</span>';
                ...
                archetypeNodes.forEach(node => {
                    ...
                    const hideInfo = () => {
                        archetypeInfo.innerHTML = defaultPlaceholderHTML;
                    };
