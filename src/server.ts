        ...
        <body>
            ...
            <main id="main-content">
                ...
                <section id="mythic-mirror">
                    ...
                    <div id="archetype-info" aria-live="polite"><span class="info-placeholder" style="opacity: 0.6;">Hover or focus an archetype node to view its mandate.</span></div>
            ...
            <script nonce="${res.locals.nonce}">
                ...
                const defaultPlaceholder = '<span class="info-placeholder" style="opacity: 0.6;">Hover or focus an archetype node to view its mandate.</span>';
                ...
                archetypeNodes.forEach(node => {
                    ...
                    node.addEventListener('blur', restoreInfo);
                });
