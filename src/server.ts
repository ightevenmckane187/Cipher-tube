  ...
  res.send(`
        ...
        <body>
            ...
            <main id="main-content">
                ...
                <section id="mythic-mirror">
                    ...
                    <div id="archetype-info" aria-live="polite">
                        <div class="info-placeholder" style="opacity: 0.7; font-style: italic;">Hover or focus an archetype node to view its mandate.</div>
                    </div>
            ...
            <script nonce="${res.locals.nonce}">
                ...
                const defaultPlaceholder = '<div class="info-placeholder" style="opacity: 0.7; font-style: italic;">Hover or focus an archetype node to view its mandate.</div>';
