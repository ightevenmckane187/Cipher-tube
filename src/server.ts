  ...
  res.send(`
        ...
        <body>
            ...
            <main id="main-content">
                ...
                <section id="mythic-mirror">
                    ...
                    <div id="archetype-info" aria-live="polite">
                        <span class="info-placeholder">Hover or focus an archetype node above to reveal its mandate.</span>
                    </div>
            ...
            <script nonce="${res.locals.nonce}">
                ...
                const defaultPlaceholder = '<span class="info-placeholder">Hover or focus an archetype node above to reveal its mandate.</span>';
