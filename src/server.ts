  ...
  res.send(`
        ...
        <head>
            ...
            <style nonce="${res.locals.nonce}">
                ...
                .info-placeholder { font-style: italic; opacity: 0.7; }
                ${CosmologyMap.getAuraStyles()}
            </style>
        </head>
        <body>
            ...
            <main id="main-content">
                ...
                <section id="mythic-mirror">
                    ...
                    <div id="archetype-info" aria-live="polite">
                        <span class="info-placeholder">Hover or focus an archetype to view its mythic mandate.</span>
                    </div>
            ...
            <script nonce="${res.locals.nonce}">
                ...
                const defaultPlaceholder = '<span class="info-placeholder">Hover or focus an archetype to view its mythic mandate.</span>';
