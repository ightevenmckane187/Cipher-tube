        ...
        <body>
            ...
            <main id="main-content">
                ...
                <section id="mythic-mirror">
                    ...
                    <div id="archetype-info" aria-live="polite"><span class="info-placeholder">Hover or focus on an archetype node to reveal its cosmic mandate.</span></div>
            ...
            <script nonce="${res.locals.nonce}">
                ...
                archetypeNodes.forEach(node => {
                    ...
                    const restorePlaceholder = () => {
                        archetypeInfo.innerHTML = '<span class="info-placeholder">Hover or focus on an archetype node to reveal its cosmic mandate.</span>';
                    };
