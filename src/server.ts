...
app.use(helmet({
    ...
    frameguard: { action: 'deny' }, // Sentinel: Enforces X-Frame-Options: DENY for clickjacking protection
    hsts: {
        maxAge: 31536000,
            ...
            <main id="main-content">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <button id="theme-toggle" aria-label="Switch Theme" aria-pressed="false" aria-keyshortcuts="t">
                        ...
                        <kbd class="kb-shortcut" aria-hidden="true" style="margin-left: 4px; border: 1px solid var(--border-color);">(t)</kbd>
                    </button>
                </div>
                ...
                <div class="code-container">
                    <button class="copy-button" id="copy-curl" aria-label="Copy command to clipboard" title="Copy to clipboard" aria-keyshortcuts="c">
                        ...
                        <kbd class="kb-shortcut" aria-hidden="true" style="margin-left: 4px; border: 1px solid rgba(255,255,255,0.3);">(c)</kbd>
                    </button>
