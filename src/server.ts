...
// Sentinel: Consolidate and harden Permissions-Policy (Defense-in-depth)
// Apply early so it's present on all responses, including rate-limited ones.
...
const validateUserId = (req: Request, res: Response, next: NextFunction) => {
  ...
  // Sentinel: Prototype Pollution protection for custom headers
