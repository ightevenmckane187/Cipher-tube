  ...
  res.send(`
        ...
        <body>
            ...
            <main id="main-content">
                ...
                <section id="mythic-mirror">
                    ...
                    <div id="archetype-info" aria-live="polite">
                        <div class="info-placeholder" style="font-style: italic; opacity: 0.7;">Select or hover over any archetype node in the cosmology map to reveal its ancient mandate.</div>
                    </div>
            ...
            <script nonce="${res.locals.nonce}">
                ...
                const defaultPlaceholder = '<div class="info-placeholder" style="font-style: italic; opacity: 0.7;">Select or hover over any archetype node in the cosmology map to reveal its ancient mandate.</div>';
