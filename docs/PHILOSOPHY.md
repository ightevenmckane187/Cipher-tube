# Mythic Foundation — Philosophy & Lore

The extended mythic narrative and architectural philosophy for Sovereign Cypher-Tube was moved from the README into this document so the repository README can stay developer-focused.
...
This file contains the narrative material previously included in README.md. For technical documentation please consult docs/API.md.
